class Recipe 
  attr_accessor :steps, :ingrediants
...
guacamole = Recipe.new("Gucamole for Programmers", "2 Avacados", "Cilantro", "1 Shallot", "2 Cloves of Garlic", "Diced Tomatoes", "Diced Jalapeño", "1 Lime")
