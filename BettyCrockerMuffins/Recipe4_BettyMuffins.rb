...
# The Recipe...
muffins = Recipe.new("Betty's Hard-core #{choice} Muffins", " 2 cups Original Bisquick® mix", " 1 cup water", " 1/3 cup veg. oil", "4 1/2 teaspoons egg replacer", "3/4 cup fresh or frozen (thawede and drained ) blueberries",
"1 cup of Crisco", "2 cups confectioner sugar", "1/4 cup of water", "1 tsp. lemon extract")      
puts muffins.steps #=> []
muffins.steps[0] = "Heat oven to 400ºF. Place paper baking cup in each of 12 regular-size muffin cups, or grease bottoms only of muffin cups."
...
muffins.deocorations[0] = "Mix Crisco, confectioner sugar, 1/4 cupe of water and lemon extract together"
muffins.deocorations[1] = "Whip to a creamy texture and get ready to decorate."
muffins.deocoration[2] = "Take one hefty spoonsize of frosting and place over muffin, spreading evenly with
the back of the spoon. Don't lick that spoon, ladies!"            
muffins.deocoration[3] = "Sprinkle and serve!"
puts muffins
